...
class RegisterGroupTests(TestCase):
    ...
    def test_correct_inputs(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:register_group'),
        ...
        verify(settings.PUBLIC_KEY, response.global_signature, *signature_content)
...
class JoinGroupTests(TestCase):
    def setUp(self):
        self.message_class = msg.GlobalServerJoin
    ...
    def test_new_user_invalid_group_uuid(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:join-group'),
                                        {'data': request.dumps()})
    ...
    def test_new_user_to_existing_group(self):
        ...
        self.message_class.verify(settings.PUBLIC_KEY, 'global', response.global_signature,
                                  group_uuid=self.group.uuid,
                                  user=user_pub)
...
class IssueUOMeTests(TestCase):
    ...
    def test_add_first_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:issue_uome'),
                                        {'data': request.dumps()})
...
class ConfirmUOMeTests(TestCase):
    ...
    def test_confirm_first_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:confirm_uome'),
                                        {'data': request.dumps()})
...
class CancelUOMeTests(TestCase):
    ...
    def test_cancel_unconfirmed_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:cancel_uome'),
                                        {'data': request.dumps()})
...
class GetPendingUOMesTests(TestCase):
    ...
    def test_one_by_user_uome_and_one_for_user_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:get_pending_uomes'),
                                        {'data': request.dumps()})
        ...
        response.verify(settings.PUBLIC_KEY, 'global', response.global_signature,
                        group_uuid=str(self.group.uuid),
                        user=self.user.key,
...
class AcceptTests(TestCase):
    ...
    def test_confirm_first_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:accept_uome'),
                                        {'data': request.dumps()})
...
class GetTotalsTests(TestCase):
    ...
    def test_get_totals_no_uome(self):
        ...
        raw_response = self.client.post(reverse('global_server_app:get_totals'),
                                        {'data': request.dumps()})
